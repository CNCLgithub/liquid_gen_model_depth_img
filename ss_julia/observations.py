...
# Set up parser
parser = argparse.ArgumentParser(description='This script use to collect observations.')
# Experiments
parser.add_argument('--bgeo_path', type=str, help='bgeo path.')
parser.add_argument('--output_dir', type=str, help="output dir to save the point as txt")
...
result = numpy_from_bgeo(bgeo_path)
pos = result[0]
vel = result[1]
...
depth = get_depth_map(pos_data=pos, scene=scene_name, path = bgeo_path,output_dir=depth_output_dir) 
global depth_map
